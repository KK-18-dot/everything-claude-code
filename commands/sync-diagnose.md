...
### Evidence
- Concrete file paths, config values, or logs supporting the diagnosis

### Next Checks
- The next safest verification steps if uncertainty remains

### Recommended Action
- Ordered remediation steps, safest first
