...
複雑化する前に、最小の実行パターンを選択する。

- Skill: `.claude/skills/agent-pattern-selector/SKILL.md`
- 参照: `.claude/skills/agent-pattern-selector/references/pattern-decision-table.md`
- 原則: 単発 → chaining → routing → parallelization → orchestrator-workers → evaluator-optimizer
- セッション切替前: `.claude/skills/context-handoff/SKILL.md`
- 日本語出力の最終調整（任意）: `.claude/skills/japanese-output-polish/SKILL.md`
